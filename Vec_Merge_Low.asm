...
#
# Description: The even elements of the vector d are obtained left-to-right from the low elements of vector a. The odd 
#	       elements of the result are obtained left-to-right from the low elements of vector b. 
#
